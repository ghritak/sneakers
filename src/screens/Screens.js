...
const LogIn = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            <View style={{ marginBottom: 30, flexDirection: 'row' }}>
                <View style={{ marginTop: 130 }}>
                    ...
                    <View style={{ flexDirection: 'row', marginLeft: 50, marginTop: 25 }}>
                        ...
                        <Text style={{ fontWeight: '500' }} onPress={() => navigation.navigate()}>Create New</Text>
                    </View>
                </View>
            ...
            <View style={{ alignItems: 'center' }}>
                <Button onPress={() => navigation.goBack()} title='Log In' buttonStyle={{ backgroundColor: '#000', color: 'black', height: 50, borderRadius: 10 }} containerStyle={{ width: '75%' }} />
            </View>
